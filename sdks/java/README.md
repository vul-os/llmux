...
3. **The library is 12–17 MB** — 12,769,346 bytes on darwin/arm64.
...
| target | status |
|---|---|
| darwin/arm64 | built and smoke-tested. 12,769,346 bytes. The measurements on this page are from here. |
