...
| [The C ABI](c-abi.md) | Six functions, the ownership rules, the costs, and the honest platform matrix |
| [Language packages](sdks.md) | What ships per language, the sidecar contract, and how to test it |
