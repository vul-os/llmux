...
```mermaid
flowchart TD
    product["product (Vulos OS assistant, Diwan AI, app AI features, …)<br/>POST /v1/chat/... · Authorization: Bearer &lt;token&gt;"] --> auth
...
> (the Vulos OS assistant, the mail connector's AI, Diwan AI, …) at llmux and threading the
