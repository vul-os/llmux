<!-- Generated from docs/c-abi.md by `go run ./site/gen`. Do not edit this file. -->
# The C ABI
...
[`ffi/README.md`](https://github.com/vul-os/llmux/blob/main/ffi/README.md); the header itself,
[`ffi/include/llmux.h`](https://github.com/vul-os/llmux/blob/main/ffi/include/llmux.h), is the normative surface.
...
[`ffi/ctest/smoke.c`](https://github.com/vul-os/llmux/blob/main/ffi/ctest/smoke.c) asserts this by comparing
...
Measured, not asserted. [`ffi/bench`](https://github.com/vul-os/llmux/blob/main/ffi/bench) dlopens the real shared
...
- [`ffi/README.md`](https://github.com/vul-os/llmux/blob/main/ffi/README.md) — layout, build detail, test strategy
- [`ffi/include/llmux.h`](https://github.com/vul-os/llmux/blob/main/ffi/include/llmux.h) — the normative header
