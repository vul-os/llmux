...
// UsageStats aggregates usage in memory (the /admin/usage endpoint's source,
// and readable directly by an embedding host).
...
// NewUsageStats builds an empty in-memory usage aggregator.
...
// Snapshot returns a copy of the aggregated totals, keyed by "total", "by_key"
// and "by_model" (the /admin/usage response shape).
